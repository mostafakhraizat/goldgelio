...
class RegCorInformation extends StatefulWidget {
  const RegCorInformation({Key? key}) : super(key: key);

  @override
  _RegCorInformationState createState() => _RegCorInformationState();
}

class _RegCorInformationState extends State<RegCorInformation> {
  @override
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: const Padding(
                            ...
                            child:  Center(child: Text('Back',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),)),
                          ),
                        ),
                      ),
                      Container(
